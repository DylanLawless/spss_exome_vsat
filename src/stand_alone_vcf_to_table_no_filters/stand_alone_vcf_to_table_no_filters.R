...
# for (f in 1:length(file_list)) {
	source("../stand_alone_vcf_to_table_no_filters/gather_no_filters.R")
	source("../stand_alone_vcf_to_table_no_filters/genotype_clean_no_filters.R")
	source("../stand_alone_vcf_to_table_no_filters/progress_bar_no_filters.R")
