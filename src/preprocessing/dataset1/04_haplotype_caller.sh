...
# sbatch --array=0-167 04_haplotype_caller.sh
...
WORK_DIR2="/work/gr-fe/lawless/spss/exome/dataset2/data"
...
INTERVAL_LIST="$WORK_DIR2/twist_humancorePlusRefSeq/Twist_Exome_RefSeq_targets_hg38.bed"
