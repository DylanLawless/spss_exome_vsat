...
mainfiles=(
# "bcftools_gatk_norm_maf01.recode_vep_conda_impact" 
"bcftools_gatk_norm_maf01.recode_vep_conda_small_impact_gnomad"
)
# "bcftools_gatk_norm_maf01.recode_vep_conda_impact_iuis"
