...
# Time: for 380 samples, 50 minutes for long chr, and 5min for shortest.
# Time: for ~1000 samples, 120 minutes for longest chr. Expect <2 hour total if all array run together.
...
# Path
INPUT_DIR="${WORK_DIR}/genomics_db_import_output"
