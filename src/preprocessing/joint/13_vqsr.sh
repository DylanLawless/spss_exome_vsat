...
# Path: temp work
INPUT_DIR="${WORK_DIR}/genotype_gvcf_output"
OUTPUT_DIR="${WORK_DIR}/vqsr_output"

# Create directories
mkdir -p ${SCRATCH_DIR}/temp/${SLURM_JOBID}/io

# Run VQSR
$GATK --java-options "-Djava.io.tmpdir=${SCRATCH_DIR}/temp/${SLURM_JOBID}/io -Xms24G -Xmx24G -XX:ParallelGCThreads=8" VariantRecalibrator \
...
# Apply VQSR
$GATK --java-options "-Djava.io.tmpdir=${SCRATCH_DIR}/temp/${SLURM_JOBID}/io -Xms24G -Xmx24G -XX:ParallelGCThreads=8" ApplyVQSR \
	-V ${INPUT_DIR}/merged.vcf.gz \
